...
- PR bodies: do not append `🤖 Generated with [Claude Code]...` or any similar footer.
- Commit messages: do not add the `Co-Authored-By: Claude ...` trailer — the commit message is the `[Scope]: message` line and nothing else.
...
- Commit message contains a `Co-Authored-By: Claude ...` trailer → remove it
