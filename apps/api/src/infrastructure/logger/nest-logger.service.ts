...
export class NestLoggerService implements LoggerService {
  ...
  log(message: unknown, ...optionalParams: unknown[]) {
    this.logger.info(formatMessage(message), getLogMetadata(optionalParams));
  }

  error(message: unknown, ...optionalParams: unknown[]) {
    this.logger.error(formatMessage(message), getErrorMetadata(optionalParams));
  }

  warn(message: unknown, ...optionalParams: unknown[]) {
    this.logger.warn(formatMessage(message), getLogMetadata(optionalParams));
  }

  debug(message: unknown, ...optionalParams: unknown[]) {
    this.logger.debug(formatMessage(message), getLogMetadata(optionalParams));
  }

  verbose(message: unknown, ...optionalParams: unknown[]) {
    this.logger.verbose(formatMessage(message), getLogMetadata(optionalParams));
  }

  fatal(message: unknown, ...optionalParams: unknown[]) {
    this.logger.error(formatMessage(message), {
      ...getErrorMetadata(optionalParams),
      level: 'fatal',
    });
  }
}
